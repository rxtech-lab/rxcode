...
public actor CLISessionStore {
    ...
    /// Resolve the on-disk projects directory for a RxCode-known cwd. Prefers
    ...
    public func loadSummaries(
        ...
        for url in files {
            ...
            summaries.append(ChatSession.Summary(
                ...
                agentProvider: meta.agentProvider ?? .claudeCode,
                model: meta.model,
                effort: meta.effort,
    ...
    /// found. Survives RxCode-side rewrites (PickerExposer, LegacyMigrator) that
